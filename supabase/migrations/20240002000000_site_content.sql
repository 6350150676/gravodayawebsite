-- ============================================================
-- Garvoday Developers â€” Editable Site Content
-- ------------------------------------------------------------
...
-- â”€â”€ 1. City presentation columns (Prime Locations section) â”€â”€
...
-- â”€â”€ 2. Key/value settings (singletons: hero, contact, brand) â”€â”€
...
-- â”€â”€ 3. Stats counters (the "15+ years / 500+ families" strip) â”€â”€
...
-- â”€â”€ 4. "Why choose us" bullet points â”€â”€
...
-- â”€â”€ 5. Intent cards ("Buy / Rent / Sell" promo cards) â”€â”€
...
-- â”€â”€ updated_at trigger on settings (reuses set_updated_at) â”€â”€
...
-- ============================================================
-- ROW LEVEL SECURITY  (public read Â· admin write)
-- ============================================================
...
insert into site_settings (key, value) values
  ...
  ('contact_address','Race Course Road, Dehradun, Uttarakhand â€” 248001'),
  ('hero_badge',     'Uttarakhand''s Most Trusted Real Estate'),
  ('hero_title',     'Find Your Dream Home in the Himalayas'),
  ('hero_subtitle',  'Apartments, villas, plots & commercial spaces across Dehradun Â· Haridwar Â· Rishikesh'),
  ...
  ('company_tagline','Trusted Since 2008 Â· Dehradun'),
  ('rating_value',   '5.0'),
  ('rating_count',   '120+')
on conflict (key) do nothing;

-- â”€â”€ Stats (only seed when empty, so re-running won't duplicate) â”€â”€
...
-- â”€â”€ "Why choose us" features (only seed when empty) â”€â”€
...
select * from (values
  ...
  ('Transparent pricing â€” no hidden charges',                       3),
...
-- â”€â”€ Intent cards / Buy Â· Rent Â· Sell (only seed when empty) â”€â”€
...
select * from (values
  ...
  ('Rent a Property', 'Comfortable living spaces',
   ...
   'Browse Rentals â†’', '/properties?type=rent',
